...
(function (Hogan, useArrayBuffer) {
  ...
  Hogan.templateDirectory = function(_dirPath) {
    if (typeof _dirPath === 'undefined') { return dirPath; }

    dirPath = path.normalize(_dirPath);
  };

  Hogan.fileExtension = function(_fileExt) {
    if (typeof _fileExt === 'undefined') { return fileExt.slice(1); }
  ...
  Hogan.Template.prototype = {
    ...
    ep: function(symbol, partials) {
      ...
      if (typeof template === 'undefined') {
        var partialPath = path.join(dirPath, partial.name + fileExt);
